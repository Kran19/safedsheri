...
export default function SafedSheriLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#2D1F0E] font-sans selection:bg-[#F6C85F]/50 selection:text-[#2D1F0E] relative overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#EAD9B8] px-3 sm:px-6 py-2.5 sm:py-3.5 shadow-sm transition-all">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-xs tracking-[0.2em] uppercase font-semibold text-[#6E5336]">
            <a href="#call" className="hover:text-[#D99427] transition" onMouseEnter={() => garbaAudio.playDandiya(0.15)}>The Concept</a>
            <a href="#colour" className="hover:text-[#D99427] transition" onMouseEnter={() => garbaAudio.playDandiya(0.15)}>Dress Code</a>
            <a href="#gazebos" className="hover:text-[#D99427] transition" onMouseEnter={() => garbaAudio.playDandiya(0.15)}>Gazebo Lounges</a>
            <a href="#sponsors" className="hover:text-[#D99427] transition" onMouseEnter={() => garbaAudio.playDandiya(0.15)}>Our Partners</a>
            <a href="#passes" className="hover:text-[#D99427] transition" onMouseEnter={() => garbaAudio.playDandiya(0.15)}>Passes</a>
          </div>
      ...
      <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-6 md:max-w-md z-30 bg-white/95 backdrop-blur-lg border-2 border-[#D99427] rounded-2xl p-4 shadow-xl shadow-[#D99427]/10 flex items-center space-x-4 animate-fade-in">
                  ...
                  <div className="space-y-6 animate-fade-in py-2">
                    ...
                    <div className="p-8 rounded-3xl bg-gradient-to-b from-[#FFFDF9] to-[#F8F3E8] border-2 border-[#EAD9B8] shadow-lg max-w-md mx-auto text-center space-y-6">
                      ...
                      <button
                        ...
                        className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#F6C85F] via-[#E5A93C] to-[#D99427] text-[#2D1F0E] font-bold text-xs tracking-widest uppercase hover:opacity-95 shadow-md shadow-[#D99427]/20 flex items-center justify-center space-x-2 transition"
                      >
