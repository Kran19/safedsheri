...
export default function CashierDeskTerminal({ hideHeader = false }: { hideHeader?: boolean }) {
  ...
  async function handleManualSubmit(e: React.FormEvent) {
    ...
    if (res.success && res.data) {
      if (res.data.registration?.status === 'CASHIER_PENDING') {
        setManualSuccessResult(res.data);
        setMessage(res.message || 'Pass request submitted to admin for approval. Passes will be issued once approved and paid.');
      } else if (manualForm.paymentMethod === 'UPI_QR') {
