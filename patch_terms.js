...
const newTerms = `<div className="bg-[#FAF6EE] p-5 rounded-2xl border border-[#EAD9B8] mt-6 text-left shadow-sm">
...
code = code.replace(
  /<div className="bg-\[\#FAF6EE\] p-5 rounded-2xl border border-\[\#EAD9B8\] mt-6 text-left shadow-sm">[\s\S]*?<\/label>[\s\S]*?<\/div>/,
  newTerms
);
